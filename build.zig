...
pub fn build(b: *std.Build) !void {
    ...
    const run_step = b.step("run", "Run SSoPlanMoSimu");
    ...
    sdk.link(unit_tests, .dynamic, .SDL2);
    sdk.link(unit_tests, .dynamic, .SDL2_ttf);
    unit_tests.root_module.addImport("sdl2", sdk.getWrapperModule());
